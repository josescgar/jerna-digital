...
imageAlt: 'Página de inicio de Jerna Digital en modo claro mostrando la sección hero'
publishedAt: 2026-02-12
featured: true
draft: false
lang: es
urlSlug: jerna-digital
ogTitle: 'Construyendo Jerna Digital: Desarrollo 100% AI-Agéntico'
ogDescription: 'Cómo este sitio fue construido completamente por agentes de IA — del primer commit a producción. Cada línea de código generada por IA.'
---
